...
export class AppComponent {
  ...
  constructor(public afs: AngularFirestore, public afAuth: AngularFireAuth, public snackBar: MatSnackBar) {
    ...
    this.user.subscribe((user: firebase.User) => {
      ...
      if (user) { // User is signed in!
        ...
        this.messages = this.afs.collection<any>('messages', ref => ref.limit(12)).valueChanges();
